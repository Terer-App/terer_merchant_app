...
import '../outlet/outlet_dto.dart';

part 'customer_order_with_history_dto.freezed.dart';
part 'customer_order_with_history_dto.g.dart';

CustomerOrderWithHistoryDto customerOrderWithHistoryDtoFromJson(String str) =>
    CustomerOrderWithHistoryDto.fromJson(json.decode(str));
...
class CustomerOrderWithHistoryDto with _$CustomerOrderWithHistoryDto {
  const factory CustomerOrderWithHistoryDto({
    ...
    @JsonKey(name: 'dealPrice') required double dealPrice,
    @JsonKey(name: 'dealName') required String dealName,
    @JsonKey(name: 'datePurchase') required DateTime datePurchase,
    @JsonKey(name: 'dateExpired') required DateTime dateExpired,
    @JsonKey(name: 'noOfCoupons') required int noOfCoupons,
    @JsonKey(name: 'noOfCouponsRedeemed') required int noOfCouponsRedeemed,
    @JsonKey(name: 'giftedCount') required int giftedCount,
    @JsonKey(name: 'isGifted') required int isGifted,
    @JsonKey(name: 'redemptionHistory')
        required List<RedemptionHistory> redemptionHistory,
  }) = _CustomerOrderWithHistoryDto;

  factory CustomerOrderWithHistoryDto.fromJson(Map<String, dynamic> json) =>
...
class RedemptionHistory with _$RedemptionHistory {
  const factory RedemptionHistory({
    ...
    @JsonKey(name: 'isGifted') required bool isGifted,
  ...
  factory RedemptionHistory.fromJson(Map<String, dynamic> json) =>
      _$RedemptionHistoryFromJson(json);
}
