...
class LiveDealDetailsEvent with _$LiveDealDetailsEvent {
  ...
  const factory LiveDealDetailsEvent.emitFromAnywhere(
      {required LiveDealDetailsState state}) = _EmitFromAnywhere;
  const factory LiveDealDetailsEvent.onVariantChange({
